...
public class Hashtag_annee_mois extends JFrame {
    static int nb;
	private static final long serialVersionUID = 1L;
	public Hashtag_annee_mois () {        
        initUI();
    }
    private void initUI() {
        ...
        add(chartPanel);
        pack();
        setTitle("Nombre de hashtags des "+nb+" denières années");
    ...
    private CategoryDataset createDataset(int nb) {
        ...
        int m,a;
             ...
             while(j<nb)
             {
                 ...
                 int month2 = localDate2.getMonthValue(); int y2=localDate2.getYear();           	
        	 if (m==month2 && a==y2)
        	 {    
    ...
    private JFreeChart createChart(CategoryDataset dataset) {
        JFreeChart barChart = ChartFactory.createBarChart("Nombre de hashtags pendant le(s) "+nb+" dernière(s) années ","","Nombre de hashtags",dataset,PlotOrientation.VERTICAL,
            false, true, false);
