...
public class TWEETS_CONFIG_CONT extends javax.swing.JFrame {
    ...
    public TWEETS_CONFIG_CONT() {
        initComponents();
        
        chechboxPeriodeParDef.setSelected(dateD);
        checkboxPeriodePers.setSelected(dateP);
        
        if(checkboxPeriodePers.isSelected())
        {
            dateDebut.setDate(date1); 
    ...
    private void initComponents() {
        ...
        jTextPane1.setText("Le mode par défaut permet d'afficher tous les tweets dans le compte depuis sa création.");
        ...
        jTextPane2.setText("Le mode personnalisé permet de définir une date de début et une date de fin pour un affichage plus précis des tweets.");
    ...
    private void btnSauvegarder_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSauvegarder_ActionPerformed
        ...
        {   // si une periode personnalisee a ete choisit
            if(checkboxPeriodePers.isSelected())
            {
                ...
                date1=dateDebut.getDate();
                date2=dateFin.getDate();
