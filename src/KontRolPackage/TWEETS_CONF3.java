...
public class TWEETS_CONF3 extends javax.swing.JFrame {
    ...
    private void btnSauvegarder_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSauvegarder_ActionPerformed
        ...
        //modificztions de la page
               ...
               if(annee)
               {
                    ...
                    try 
                    {
                         Tweet_annee_annee.nb=anneeT;
                         Tweet_annee_annee ex = new Tweet_annee_annee("Nombre de tweets ce(s) "+anneeT+" dernière(s) année(s)");
               ...
               else
               {
                    ...
                    try 
                    {
                         Tweet_annee_mois.nb=anneeT;
                         Tweet_annee_mois ex = new Tweet_annee_mois("Nombre de tweets ce(s) "+anneeT+" dernière(s) année(s)");
