...
public class HASHTAG_RECHERCHE extends javax.swing.JFrame {

    public HASHTAG_RECHERCHE() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        texteHahstag = new javax.swing.JTextField();
        jLabel2 = new javax.swing.JLabel();
        jSeparator4 = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        contenuHashtag = new javax.swing.JTextArea();
        btnChercherHash_ = new javax.swing.JButton();
        btnViderRechHash_ = new javax.swing.JButton();
        ...
        jLabel1.setText("Recherche Hashtag");
        ...
        texteHahstag.setFont(new java.awt.Font("Segoe UI Light", 0, 14)); // NOI18N
        texteHahstag.setForeground(new java.awt.Color(51, 51, 51));
        texteHahstag.setBorder(null);

        jLabel2.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 153, 255));
        jLabel2.setText("#");

        contenuHashtag.setColumns(75);
        contenuHashtag.setFont(new java.awt.Font("Segoe UI Light", 0, 12)); // NOI18N
        contenuHashtag.setLineWrap(true);
        contenuHashtag.setRows(1000);
        contenuHashtag.setToolTipText("Tweets et retweets reliés au hashtag cherché.");
        jScrollPane1.setViewportView(contenuHashtag);

        btnChercherHash_.setIcon(new javax.swing.ImageIcon(getClass().getResource("/KontRolPackage/Search_32px.png"))); // NOI18N
        btnChercherHash_.setToolTipText("Lancer la recherche.");
        btnChercherHash_.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        ...
        btnViderRechHash_.setFont(new java.awt.Font("Segoe UI Light", 0, 14)); // NOI18N
        btnViderRechHash_.setForeground(new java.awt.Color(0, 153, 255));
        btnViderRechHash_.setText("Vider");
        btnViderRechHash_.setToolTipText("Vider le champ du texte.");
        btnViderRechHash_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 255), 1, true));
        btnViderRechHash_.setContentAreaFilled(false);
        btnViderRechHash_.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnViderRechHash_.setFocusPainted(false);
        btnViderRechHash_.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnViderRechHash_MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnViderRechHash_MouseExited(evt);
            }
        });
        btnViderRechHash_.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnViderRechHash_ActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(btnViderRechHash_, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel2Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(texteHahstag))
                                .addComponent(jSeparator4))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            .addComponent(btnChercherHash_, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(16, 16, 16))
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(texteHahstag, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel18))
                        .addGap(3, 3, 3)
                        .addComponent(jSeparator4, javax.swing.GroupLayout.PREFERRED_SIZE, 10, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(btnChercherHash_, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(21, 21, 21)
                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 241, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnViderRechHash_, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    public void ChercherHashtag (String user)
    {
        
        //la connexion a l API et extraction des Hashtags
         ...
         while (true) 
         {
             try 
             {
                   ...
                   statuses.addAll(cnx.getUserTimeline(user, page));
                    ...
                    contenuHashtag.setRows(statuses.size());
         ...
         //insertion du texte dans le champs 
          int i=0,k=0;
	  ...
	  {   	            
	    ...
	    {
	      	tab[i]=hashTags[i].getText();	      	               
	      	
                if(tab[i].toLowerCase().equals(texteHahstag.getText().toLowerCase()))
	      	{ 
                    contenuHashtag.setLineWrap(true);
                    if(status.isRetweet())
                    { 
                        
                        contenuHashtag.append("\n\n << Retweet >> \n\n Nom d'utilisateur: @"+status.getUser().getName()+""
    ...
    private void btnMinimiserFenetreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMinimiserFenetreActionPerformed
        ...
        HASHTAG_RECHERCHE.this.setState(ICONIFIED);
    ...
    private void btnChercherHash_MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnChercherHash_MouseExited
        bordureBlanche(btnChercherHash_);
    ...
    private void btnChercherHash_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChercherHash_ActionPerformed
        ChercherHashtag(LOGIN_CIBLE.userCible);
    }//GEN-LAST:event_btnChercherHash_ActionPerformed

    private void btnViderRechHash_MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnViderRechHash_MouseEntered
        
        btnViderRechHash_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 255),2, true));

        DASHBOARD.Police_Gras(btnViderRechHash_);
    }//GEN-LAST:event_btnViderRechHash_MouseEntered

    private void btnViderRechHash_MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnViderRechHash_MouseExited
     
        btnViderRechHash_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 255), 1, true));
         DASHBOARD.Police_Normal(btnViderRechHash_);
    }//GEN-LAST:event_btnViderRechHash_MouseExited

    private void btnViderRechHash_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViderRechHash_ActionPerformed
        contenuHashtag.setText("");
        
    }//GEN-LAST:event_btnViderRechHash_ActionPerformed
    ...
    private javax.swing.JButton btnViderRechHash_;
    private javax.swing.JTextArea contenuHashtag;
    ...
    private javax.swing.JTextField texteHahstag;
