...
public class APROPOS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        texteAPropos = new javax.swing.JTextArea();
        ...
        jLabel1.setText("À propos");

        jSeparator6.setForeground(new java.awt.Color(0, 153, 255));

        jSeparator7.setForeground(new java.awt.Color(0, 153, 255));

        texteAPropos.setColumns(20);
        texteAPropos.setFont(new java.awt.Font("Segoe UI Light", 0, 13)); // NOI18N
        texteAPropos.setForeground(new java.awt.Color(51, 51, 51));
        texteAPropos.setRows(5);
        texteAPropos.setText("   \n   KONTROL est une application desktop développée en 2018 par les étudiants de l'USTHB\n   dans le cadre du projet de fin d'études Licence Informatique Générale.\n   Elle est destinée aux parents qui souhaitent suivre leurs enfants sur le réseau social Twitter.\n\n   À travers cette application vous pouvez:\n\n   - Vérifier l'état actuel du compte Twitter de votre enfant.\n   - Récupérer les différents types d'informations liées au compte Twitter de votre enfant.\n   - Consulter les statistiques relatives au compte de l'enfant. \n   - Se renseigner sur les profils suspects qui interagissent avec votre enfant.\n   - Accéder à votre compte Twitter via l'application.\n     Et encore plus...\n\n    Facile à utiliser, KONTROL vous permet de garder un oeuil sur les activités \n    de vos enfants sur Twitter tout en gardant leur coin privé. ");
        texteAPropos.setToolTipText("");
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(btnProfil_, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnMinimiserFenetreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMinimiserFenetreActionPerformed
        APROPOS.this.setState(ICONIFIED);
    ...
    private javax.swing.JTextArea texteAPropos;
