...
public class ABONNES extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnListeAbn_ = new javax.swing.JButton();
        btnChercherAbn_ = new javax.swing.JButton();
        btnAbnsCom_ = new javax.swing.JButton();
        ...
        jLabel8.setText("Abonnés en commun");

        jLabel16.setFont(new java.awt.Font("Segoe UI Light", 0, 14)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(51, 51, 51));
        jLabel16.setText("Afficher la liste des abonnés en communs avec moi.");

        jLabel11.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(0, 153, 255));
        jLabel11.setText("Liste d'abonnés");

        jLabel17.setFont(new java.awt.Font("Segoe UI Light", 0, 14)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(51, 51, 51));
        jLabel17.setText("Vérifier l'existance d'un abonné précis.");

        jLabel15.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(0, 153, 255));
        jLabel15.setText("Chercher Abonné");

        jLabel18.setFont(new java.awt.Font("Segoe UI Light", 0, 14)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(51, 51, 51));
        jLabel18.setText("Afficher la liste des abonnés.");

        btnListeAbn_.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        btnListeAbn_.setForeground(new java.awt.Color(0, 153, 255));
        btnListeAbn_.setIcon(new javax.swing.ImageIcon(getClass().getResource("/KontRolPackage/Resume_52px.png"))); // NOI18N
        btnListeAbn_.setToolTipText("");
        btnListeAbn_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        btnListeAbn_.setContentAreaFilled(false);
        btnListeAbn_.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnListeAbn_.setFocusPainted(false);
        btnListeAbn_.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnListeAbn_MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnListeAbn_MouseExited(evt);
            }
        });
        btnListeAbn_.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnListeAbn_ActionPerformed(evt);
            }
        });

        btnChercherAbn_.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        btnChercherAbn_.setForeground(new java.awt.Color(0, 153, 255));
        btnChercherAbn_.setIcon(new javax.swing.ImageIcon(getClass().getResource("/KontRolPackage/Find User Male_52px.png"))); // NOI18N
        btnChercherAbn_.setToolTipText("");
        btnChercherAbn_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        btnChercherAbn_.setContentAreaFilled(false);
        btnChercherAbn_.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnChercherAbn_.setFocusPainted(false);
        btnChercherAbn_.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnChercherAbn_MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnChercherAbn_MouseExited(evt);
            }
        });
        btnChercherAbn_.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnChercherAbn_ActionPerformed(evt);
            }
        });

        btnAbnsCom_.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        btnAbnsCom_.setForeground(new java.awt.Color(0, 153, 255));
        btnAbnsCom_.setIcon(new javax.swing.ImageIcon(getClass().getResource("/KontRolPackage/Safety Collection Place_52px.png"))); // NOI18N
        btnAbnsCom_.setToolTipText("");
        btnAbnsCom_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        btnAbnsCom_.setContentAreaFilled(false);
        btnAbnsCom_.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnAbnsCom_.setFocusPainted(false);
        btnAbnsCom_.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnAbnsCom_MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnAbnsCom_MouseExited(evt);
            }
        });
        btnAbnsCom_.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAbnsCom_ActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnListeAbn_, javax.swing.GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE)
                    .addComponent(btnChercherAbn_, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(btnAbnsCom_, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(18, 18, 18)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnListeAbn_, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(28, 28, 28)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel15)
                    ...
                    .addComponent(btnChercherAbn_, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel8)
                    ...
                    .addComponent(btnAbnsCom_, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(40, 40, 40))
        );
    ...
    private void btnMinimiserFenetreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMinimiserFenetreActionPerformed
        ...
        ABONNES.this.setState(ICONIFIED);
    ...
    private void btnListeAbn_MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnListeAbn_MouseEntered
        bordureBleue(btnListeAbn_);
    }//GEN-LAST:event_btnListeAbn_MouseEntered

    private void btnListeAbn_MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnListeAbn_MouseExited
        btnListeAbn_.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204,204,204)));
    }//GEN-LAST:event_btnListeAbn_MouseExited

    private void btnListeAbn_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListeAbn_ActionPerformed

        ABONNES_LISTE abnsL = new ABONNES_LISTE();
        abnsL.setVisible(true);
        abnsL.setLocationRelativeTo(null);

    }//GEN-LAST:event_btnListeAbn_ActionPerformed

    private void btnChercherAbn_MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnChercherAbn_MouseEntered
        bordureBleue(btnChercherAbn_);
    }//GEN-LAST:event_btnChercherAbn_MouseEntered

    private void btnChercherAbn_MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnChercherAbn_MouseExited
        btnChercherAbn_.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204,204,204)));
    }//GEN-LAST:event_btnChercherAbn_MouseExited

    private void btnChercherAbn_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChercherAbn_ActionPerformed

        ABONNES_CHERCHER abnsC = new ABONNES_CHERCHER();
        abnsC.setVisible(true);
        abnsC.setLocationRelativeTo(null);

    }//GEN-LAST:event_btnChercherAbn_ActionPerformed

    private void btnAbnsCom_MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAbnsCom_MouseEntered
        bordureBleue(btnAbnsCom_);
    }//GEN-LAST:event_btnAbnsCom_MouseEntered

    private void btnAbnsCom_MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAbnsCom_MouseExited
      btnAbnsCom_.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204,204,204)));
    }//GEN-LAST:event_btnAbnsCom_MouseExited

    private void btnAbnsCom_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAbnsCom_ActionPerformed

        ABONNES_COMMUNS abnCmn = new ABONNES_COMMUNS();
        abnCmn.setVisible(true);
        abnCmn.setLocationRelativeTo(null);

    }//GEN-LAST:event_btnAbnsCom_ActionPerformed
    ...
    private void btnConfiguration_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfiguration_ActionPerformed
        ...
        ABONNES_CONFIG abnConf = new ABONNES_CONFIG();
        abnConf.setVisible(true);
        abnConf.setLocationRelativeTo(null);
    ...
    private javax.swing.JButton btnAbnsCom_;
    private javax.swing.JButton btnApropos_;
    private javax.swing.JButton btnChercherAbn_;
    ...
    private javax.swing.JButton btnListeAbn_;
