...
public class HASHTAGS_CONFIG_STAT_PERS extends javax.swing.JFrame {

    public static int NbrJourH=7,NbrMoisH=7,NbrAnneeH=7;
    
    public HASHTAGS_CONFIG_STAT_PERS() {
        initComponents();
        sliderJours.setValue(NbrJourH);
        sliderMois.setValue(NbrMoisH);
        sliderAnnees.setValue(NbrAnneeH);
    }
    ...
    private void btnSauvegarder_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSauvegarder_ActionPerformed
        ...
        soustitre.setText("Période personnalisée");
            HASHTAGS_STATPARDEFAUT.lblJour.setText("Nombre de hashtags ce(s) "+NbrJourH+ " dernier(s) jours.");
            HASHTAGS_STATPARDEFAUT.lblMois.setText("Nombre de hashtags ce(s)  "+NbrMoisH+" dernier(s) mois.");
            HASHTAGS_STATPARDEFAUT.lblAnnee.setText("Nombre de hashtags ce(s) "+NbrAnneeH+" dernière(s) année(s).");
            
            HASHTAGS_STATPARDEFAUT.moisH=NbrMoisH;
            HASHTAGS_STATPARDEFAUT.jourH=NbrJourH;
            HASHTAGS_STATPARDEFAUT.anneeH=NbrAnneeH;
            
            Hashtag_mois_mois.nb=NbrMoisH;
            Hashtag_Mois.nb=NbrMoisH;
            
            Hashtags_annee_annee.nb=NbrAnneeH;
            Hashtag_Annees.nb=NbrAnneeH;
           
            Hashtag_Jours.nb=NbrJourH;
    ...
    public void stateChangedJours(ChangeEvent e) {
        ...
        NbrJourH = sliderJours.getValue();
        nbrJours.setText("Jour(s) = "+NbrJourH);
    ...
    public void stateChangedMois(ChangeEvent e) {
        ...
        NbrMoisH = sliderMois.getValue();
        nbrMois.setText("Mois = "+NbrMoisH);
    ...
    public void stateChangedAnnees(ChangeEvent e) {
        ...
        NbrAnneeH= sliderAnnees.getValue();
        nbrAnnees.setText("Année(s) = "+NbrAnneeH);
