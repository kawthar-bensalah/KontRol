...
public class Tweet_mois_sem extends JFrame {
    static int nb;
    static Tweet_mois_sem ex;
	private static final long serialVersionUID = 1L;
	public Tweet_mois_sem() {        
        initUI();
    }
    private void initUI() {
    ...
    private CategoryDataset createDataset(int nb) {
		...
		while(nbr<nb)
		{ 
		type[nbr] = "Sem "+(nbr+1)+": "+format1.format(c.getTime());//Calendar.DAY_OF_MONTH;
