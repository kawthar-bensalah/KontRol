...
public class MESSAGE_SAUVEGARDER_Tweet extends javax.swing.JFrame {

    JTextArea texte1,texte2;
    
    public MESSAGE_SAUVEGARDER_Tweet(JTextArea texte1,JTextArea texte2) 
    {
        initComponents();
        this.texte1=texte1; //texte1 c les infos
        this.texte2=texte2; //texte2 c'est le texte
    }
    ...
    private void btnComprisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnComprisActionPerformed
        ...
        pw.println(" Texte :");
        pw.println(" ");
        pw.println("' "+texte2.getText()+" '");
        pw.println(" ");
        pw.println("Informations sur le tweet/retweet :");
        pw.println(" ");
        pw.println( texte1.getText());
        pw.println(" ");
        pw.println("____________________________________________");
        pw.println(" ");
