...
public class HASHTAGS_CONFIG_STAT extends javax.swing.JFrame {

   public static boolean perso =false;
   public static boolean defaut =false;
   
    public HASHTAGS_CONFIG_STAT() {
        initComponents();
        
        if(perso)
            checkBoxPers.setSelected(perso);
        else 
        
                checkBoxParDef.setSelected(defaut);
    }
        ...
        if(checkBoxPers.isSelected())
            {
               soustitre.setText("Période personnalisée");
                perso=true;
                defaut=false;
                HASHTAGS_CONFIG_STAT_PERS tp = new HASHTAGS_CONFIG_STAT_PERS();
                tp.setVisible(true);
            ...
            else
            {
                ...
                HASHTAGS_STATPARDEFAUT.lblJour.setText("Nombre de hashtags ces 7 derniers jours.");
                HASHTAGS_STATPARDEFAUT.lblMois.setText("Nombre de hashtags ces 7 derniers mois.");
                HASHTAGS_STATPARDEFAUT.lblAnnee.setText("Nombre de hashtags ces 7 dernières années.");

                HASHTAGS_STATPARDEFAUT.moisH=7;
                HASHTAGS_STATPARDEFAUT.jourH=7;
                HASHTAGS_STATPARDEFAUT.anneeH=7;

                Hashtag_mois_mois.nb=7;
                Hashtag_Mois.nb=7;

                Hashtags_annee_annee.nb=7;
                Hashtag_Annees.nb=7;
