...
public class RETWEETS_STATPARDEFAUT extends javax.swing.JFrame {
 public static int jourR=7,moisR=7,anneeR=7;
 
    public RETWEETS_STATPARDEFAUT() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Statistiques des Retweets");
        ...
        j.setText("Nombre de retweets que l'utilisateur a posté cette semaine.");

        m.setFont(new java.awt.Font("Segoe UI Light", 0, 12)); // NOI18N
        m.setForeground(new java.awt.Color(51, 51, 51));
        m.setText("Nombre de retweets que l'utilisateur a posté ces 7 dérniers mois.");

        a.setFont(new java.awt.Font("Segoe UI Light", 0, 12)); // NOI18N
        a.setForeground(new java.awt.Color(51, 51, 51));
        a.setText("Nombre de retweets que l'utilisateur a posté ces 7  dérnières années.");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(j, javax.swing.GroupLayout.PREFERRED_SIZE, 458, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(a, javax.swing.GroupLayout.DEFAULT_SIZE, 460, Short.MAX_VALUE)
    ...
    private void btnMinimiserFenetreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMinimiserFenetreActionPerformed
        RETWEETS_STATPARDEFAUT.this.setState(ICONIFIED);
    ...
    private void btnConfiguration_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfiguration_ActionPerformed
        ...
        RETWEETS_CONFIG_STAT conf = new RETWEETS_CONFIG_STAT ();
    ...
    private void btnJour_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJour_ActionPerformed
        ...
        if(RETWEETS_CONFIG_STAT.optionRetweetsPerso)
                {soustitre.setText("Période personnalisée");}
        
                 
                      try {
                          Retweets_Jours.nb =RETWEETS_CONFIG_STAT_PERS.NbrJourRT;
                    Retweets_Jours demo = new Retweets_Jours("Nombre de retweets pendant le(s) "+Retweets_Jours.nb+" dernier(s) jour(s)");
                    ...
                    demo.setLocationRelativeTo(null);
                          ...
                          Logger.getLogger(RETWEETS_STATPARDEFAUT.class.getName()).log(Level.SEVERE, null, ex);
                      }
    ...
    private void btnMois_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMois_ActionPerformed
           RETWEETS_CONF2 r = new RETWEETS_CONF2();
           r.setVisible(true);
    ...
    private void btnAnnee_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnnee_ActionPerformed
        RETWEET_CONF3 h = new RETWEET_CONF3();
       h.setVisible(true);
