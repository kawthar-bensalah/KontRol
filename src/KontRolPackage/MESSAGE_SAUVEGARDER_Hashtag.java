...
public class MESSAGE_SAUVEGARDER_Hashtag extends javax.swing.JFrame {

    JTextArea texte1H,texte2H;
    String hashtag;
    
    public MESSAGE_SAUVEGARDER_Hashtag(JTextArea texte1H,JTextArea texte2H,String hashtag) 
    {
        initComponents();
        this.texte1H=texte1H;
        this.texte2H=texte2H;
    ...
    private void btnComprisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnComprisActionPerformed
        ...
        pw.println(" ");
        pw.println("Texte :" );
        pw.println(" "+texte2H.getText());
        pw.println(" ");
        pw.println("Informations sur le tweet/retweet :");
        pw.println(" ");
        pw.println(texte1H.getText());
