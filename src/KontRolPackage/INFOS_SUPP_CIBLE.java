...
public final class INFOS_SUPP_CIBLE extends javax.swing.JFrame {

    public INFOS_SUPP_CIBLE() throws TwitterException {
        initComponents();
        InfoSuppCible(LOGIN_CIBLE.userCible);
    }
    ...
    private void initComponents() {
        ...
        infosSuppCible = new javax.swing.JTextArea();
        ...
        infosSuppCible.setColumns(20);
        infosSuppCible.setFont(new java.awt.Font("Segoe UI Light", 0, 16)); // NOI18N
        infosSuppCible.setForeground(new java.awt.Color(51, 51, 51));
        infosSuppCible.setLineWrap(true);
        infosSuppCible.setRows(15);
        panel.setViewportView(infosSuppCible);
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnManuel_, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnProfil_, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void InfoSuppCible(String user) throws TwitterException
    {
        ...
        long idf = cnx.showUser(user).getId();
        int status = cnx.showUser(user).getStatusesCount();
        
        String email = cnx.showUser(user).getEmail();
        if(email==null)
            email="  <Pas d'adresse email disponible>";
        String emplacement = cnx.showUser(user).getLocation();
        if(emplacement==null)
            emplacement="  <Pas d'emplacement disponible>";
        String temps = cnx.showUser(user).getTimeZone();
        if(temps==null)
            temps="  <Pas de TimeZone disponible>";
        String url = cnx.showUser(user).getURL();
        if(url==null)
            url="  <Pas d'URL disponible>";
        boolean verif = cnx.showUser(user) .isVerified();
        String reponse;
        if(verif)
           reponse="Oui";
          else
        ...
        boolean Location = cnx.showUser(user).isGeoEnabled();
        String location;
    ...
    private void btnMinimiserFenetreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMinimiserFenetreActionPerformed
        ...
        INFOS_SUPP_CIBLE.this.setState(ICONIFIED);
    ...
    private static javax.swing.JTextArea infosSuppCible;
