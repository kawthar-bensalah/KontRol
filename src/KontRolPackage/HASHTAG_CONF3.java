...
import static KontRolPackage.HASHTAGS_STATPARDEFAUT.anneeH;
...
public class HASHTAG_CONF3 extends javax.swing.JFrame {

    public static boolean mois=false,annee=false;
    public HASHTAG_CONF3() {
        initComponents();
        if(mois)
        {
    ...
    private void btnSauvegarder_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSauvegarder_ActionPerformed
        ...
        {
            annee = true;
            soustitre.setText("Personnalisé (En fonction des années)");
            //modificztions de la page
            lblJour.setText("Nombre de hashtags que l'utilisateur a utilisé ce(s) "+NbrJourH+ " dérnier(s) jours.");
            lblMois.setText("Nombre de hashtags que l'utilisateur a utilisé ce(s)  "+NbrMoisH+" dérnier(s) mois.");
            lblAnnee.setText("Nombre de hashtags que l'utilisateur a utilisé ce(s) "+NbrAnneeH+" dérnière(s) année(s).");
        ...
        if(mois)
           { 
                anneeH=HASHTAGS_CONFIG_STAT_PERS.NbrAnneeH;
                Hashtag_Annees.nb=anneeH;
                Hashtag_Annees ex = new Hashtag_Annees();
                Barre(ex);
           }
           else
           {
               ...
               {
                anneeH=HASHTAGS_CONFIG_STAT_PERS.NbrAnneeH;
                Hashtags_annee_annee.nb=anneeH;
                Hashtags_annee_annee ex = new Hashtags_annee_annee();
                Barre(ex);
