...
public class Mentions_annee_annee extends JFrame {
    private static final long serialVersionUID = 1L;
    static int nb;
    public Mentions_annee_annee() throws TwitterException {
          
        PieDataset dataset = createDataset(nb);       
        JFreeChart chart = createChart(dataset, "Nombre de mentions pendant le(s) "+nb+" dernière(s) année(s)");       
