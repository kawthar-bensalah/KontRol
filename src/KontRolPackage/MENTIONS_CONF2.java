...
public class MENTIONS_CONF2 extends javax.swing.JFrame {

    public static boolean mois=false;
    public static boolean semaine = false;
    
    public MENTIONS_CONF2() {
        initComponents();
      if(mois)
        {
        ...
        else
        {
            ...
            anneeM=NbrAnneeM;
                ...
                if(mois)
               {
                    try 
                    {
                        Mention_mois_mois.nb=moisM;
                        Mention_mois_mois ex = new Mention_mois_mois();
                        ex.setSize(650, 400);
                        ex.setVisible(true);
                    ...
                    {
                        Logger.getLogger(MENTIONS_CONF2.class.getName()).log(Level.SEVERE, null, ex1);
                    }
                
               }
               else
               {
                   Mentions_Mois.nb=moisM;
                   Mentions_Mois ex = new Mentions_Mois();
                   ex.setSize(650, 400);
                   ex.setVisible(true);
                   ex.setLocationRelativeTo(null);
               }
