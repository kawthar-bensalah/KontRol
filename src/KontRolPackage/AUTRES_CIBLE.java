...
public class AUTRES_CIBLE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnInfosSuppCible_ = new javax.swing.JButton();
        btnDegreCible_ = new javax.swing.JButton();
        jLabel9 = new javax.swing.JLabel();
        btnParamsAffCible_ = new javax.swing.JButton();
        ...
        btnInfosSuppCible_.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        btnInfosSuppCible_.setForeground(new java.awt.Color(0, 153, 255));
        btnInfosSuppCible_.setIcon(new javax.swing.ImageIcon(getClass().getResource("/KontRolPackage/Contact Details_48px.png"))); // NOI18N
        btnInfosSuppCible_.setToolTipText("");
        btnInfosSuppCible_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        btnInfosSuppCible_.setContentAreaFilled(false);
        btnInfosSuppCible_.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnInfosSuppCible_.setFocusPainted(false);
        btnInfosSuppCible_.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnInfosSuppCible_MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnInfosSuppCible_MouseExited(evt);
            }
        });
        btnInfosSuppCible_.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnInfosSuppCible_ActionPerformed(evt);
            }
        });

        btnDegreCible_.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        btnDegreCible_.setForeground(new java.awt.Color(0, 153, 255));
        btnDegreCible_.setIcon(new javax.swing.ImageIcon(getClass().getResource("/KontRolPackage/Mind Map_48px.png"))); // NOI18N
        btnDegreCible_.setToolTipText("");
        btnDegreCible_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        btnDegreCible_.setContentAreaFilled(false);
        btnDegreCible_.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnDegreCible_.setFocusPainted(false);
        btnDegreCible_.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnDegreCible_MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnDegreCible_MouseExited(evt);
            }
        });
        btnDegreCible_.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDegreCible_ActionPerformed(evt);
            }
        });
        ...
        btnParamsAffCible_.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        btnParamsAffCible_.setForeground(new java.awt.Color(0, 153, 255));
        btnParamsAffCible_.setIcon(new javax.swing.ImageIcon(getClass().getResource("/KontRolPackage/Medium Icons_48px.png"))); // NOI18N
        btnParamsAffCible_.setToolTipText("");
        btnParamsAffCible_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        btnParamsAffCible_.setContentAreaFilled(false);
        btnParamsAffCible_.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnParamsAffCible_.setFocusPainted(false);
        btnParamsAffCible_.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnParamsAffCible_MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnParamsAffCible_MouseExited(evt);
            }
        });
        btnParamsAffCible_.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnParamsAffCible_ActionPerformed(evt);
            }
        });

        jLabel19.setFont(new java.awt.Font("Segoe UI Light", 0, 12)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(51, 51, 51));
        jLabel19.setText("Afficher le degré de danger du compte.");

        jLabel20.setFont(new java.awt.Font("Segoe UI Light", 1, 15)); // NOI18N
        jLabel20.setForeground(new java.awt.Color(0, 153, 255));
        jLabel20.setText("Degré de danger");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(btnParamsAffCible_)
                            .addComponent(btnDegreCible_)
                            .addComponent(btnInfosSuppCible_))
                        .addGap(46, 46, 46)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnParamsAffCible_, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel15)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnMinimiserFenetreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMinimiserFenetreActionPerformed
        ...
        AUTRES_CIBLE.this.setState(ICONIFIED);
    }//GEN-LAST:event_btnMinimiserFenetreActionPerformed

    private void btnInfosSuppCible_MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInfosSuppCible_MouseEntered
        bordureBleue(btnInfosSuppCible_);
    }//GEN-LAST:event_btnInfosSuppCible_MouseEntered

    private void btnInfosSuppCible_MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInfosSuppCible_MouseExited
        btnInfosSuppCible_.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204,204,204)));
    }//GEN-LAST:event_btnInfosSuppCible_MouseExited

    private void btnInfosSuppCible_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInfosSuppCible_ActionPerformed

        
        try 
        {
           INFOS_SUPP_CIBLE i = new INFOS_SUPP_CIBLE();
           i.setVisible(true);
        ...
        {
            Logger.getLogger(AUTRES_CIBLE.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        
    }//GEN-LAST:event_btnInfosSuppCible_ActionPerformed

    private void btnDegreCible_MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDegreCible_MouseEntered
        bordureBleue(btnDegreCible_);
    }//GEN-LAST:event_btnDegreCible_MouseEntered

    private void btnDegreCible_MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDegreCible_MouseExited
        btnDegreCible_.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204,204,204)));
    }//GEN-LAST:event_btnDegreCible_MouseExited

    private void btnDegreCible_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDegreCible_ActionPerformed

        DEGRE_DANGER d = new DEGRE_DANGER("");
        try {
            DEGRE_DANGER.aff();
    ...
    }//GEN-LAST:event_btnDegreCible_ActionPerformed

    private void btnParamsAffCible_MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnParamsAffCible_MouseEntered
        bordureBleue(btnParamsAffCible_);
    }//GEN-LAST:event_btnParamsAffCible_MouseEntered

    private void btnParamsAffCible_MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnParamsAffCible_MouseExited
         btnParamsAffCible_.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204,204,204)));
    }//GEN-LAST:event_btnParamsAffCible_MouseExited

    private void btnParamsAffCible_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnParamsAffCible_ActionPerformed

        
        try 
        {
            PARAMS_AFF_CIBLE c = new PARAMS_AFF_CIBLE();
            c.setVisible(true);
    ...
    }//GEN-LAST:event_btnParamsAffCible_ActionPerformed
