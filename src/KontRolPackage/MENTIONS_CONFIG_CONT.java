...
public class MENTIONS_CONFIG_CONT extends javax.swing.JFrame {

    public MENTIONS_CONFIG_CONT() {
        initComponents();
    }
    public static boolean dateD = false;
    public static boolean dateP =false;
    public static Date date1M,date2M;
    ...
    private void initComponents() {
        ...
        jTextPane1.setText("Le mode par défaut permet d'afficher toutes les mentions utilisées dans le compte depuis sa création.");
        ...
        jTextPane2.setText("Le mode personnalisé permet de définir une date de début et une date de fin pour un affichage plus précis des mentions.");
    ...
    private void btnSauvegarder_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSauvegarder_ActionPerformed
        ...
        {   // si une periode personnalisee a ete choisit
            if(checkBoxPers.isSelected())
            {
                ...
                date1M=dateDebut.getDate();
                date2M=dateFin.getDate();
                dateP=true;
            }
