...
public class MENTIONS_CONF_STAT extends javax.swing.JFrame {

     public static boolean optionMentionsPerso =false;
     public static boolean optionMentionsParDef =false;
   
    public MENTIONS_CONF_STAT() {
        initComponents();
        
         if(optionMentionsPerso)
            checkBoxPers.setSelected(optionMentionsPerso);
        else 
        
                checkBoxParDef.setSelected(optionMentionsParDef);
    }
        ...
        if(checkBoxPers.isSelected())
            {
               soustitre.setText("Période personnalisée");
                optionMentionsPerso=true;
                optionMentionsParDef=false;
                MENTIONS_CONFIG_STAT_PERS tp = new MENTIONS_CONFIG_STAT_PERS();
                tp.setVisible(true);
            ...
            {
                optionMentionsParDef=true;
                optionMentionsPerso=false;

                soustitre.setText("Période par défaut");
                MENTIONS_STATPARDEF.lblJours.setText("Nombre de mentions ces 7 derniers jours.");
                MENTIONS_STATPARDEF.lblMois.setText("Nombre de mentions ces 7 derniers mois.");
                MENTIONS_STATPARDEF.lblAnnees.setText("Nombre de mentions ces 7 dernières années.");

                MENTIONS_STATPARDEF.moisM=7;
                MENTIONS_STATPARDEF.jourM=7;
                MENTIONS_STATPARDEF.anneeM=7;

                Mention_mois_mois.nb=7;
                Mentions_Mois.nb=7;

                Mentions_annee_annee.nb=7;
                Mentions_Annees.nb=7;
