...
public class Hashtag_Mois extends JFrame {
    ...
    private CategoryDataset createDataset(int nb) {
        ...
        e.printStackTrace();
             ...
             int jour=localDate.getDayOfMonth();
             while(j<nb)
             {
    ...
    private JFreeChart createChart(CategoryDataset dataset) {
        JFreeChart barChart = ChartFactory.createBarChart("Nombre de hashtags pendant le(s) "+nb+" denier(s) mois","","Nombre de hashtags",dataset,PlotOrientation.VERTICAL,
            false, true, false);
