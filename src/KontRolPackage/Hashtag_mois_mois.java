...
public class Hashtag_mois_mois extends JFrame {
    static int nb;
	private static final long serialVersionUID = 1L;
	public Hashtag_mois_mois() {        
        initUI();
    }
    private void initUI() {
    ...
    private JFreeChart createChart(CategoryDataset dataset) {
        JFreeChart barChart = ChartFactory.createBarChart("Nombre de hashtags pendant le(s) "+nb+" derniers mois ","","Nombre de hashtags",dataset,PlotOrientation.VERTICAL,
            false, true, false);
