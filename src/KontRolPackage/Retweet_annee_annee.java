...
public class Retweet_annee_annee extends ApplicationFrame {
	private static final long serialVersionUID = 1L;
	static int nb;
    public Retweet_annee_annee(final String title) throws TwitterException {
        super(title);
  ...
  //les tweets
    ...
    private JFreeChart createChart(final CategoryDataset dataset) {      
        final JFreeChart chart = ChartFactory.createLineChart(
            "Nombre de retweets pendant le(s) "+nb+ " dernière(s) année(s)",       
            "Années",                   
            "Valeurs",                   
            dataset,                   
