...
public class TIMELINE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        retweets = new javax.swing.JTextArea();
        jLabel18 = new javax.swing.JLabel();
        jLabel19 = new javax.swing.JLabel();
        btnAffTweets_ = new javax.swing.JButton();
        btnViderTweets_ = new javax.swing.JButton();
        btnAffRT_ = new javax.swing.JButton();
        btnViderRT_ = new javax.swing.JButton();
        ...
        tweets.setFont(new java.awt.Font("Segoe UI Light", 0, 13)); // NOI18N
        tweets.setForeground(new java.awt.Color(51, 51, 51));
        tweets.setLineWrap(true);
        tweets.setRows(100000);
        tweets.setToolTipText("Tous les tweets depuis la création");
        tweets.setFocusable(false);
        jScrollPane1.setViewportView(tweets);

        retweets.setColumns(20);
        retweets.setFont(new java.awt.Font("Segoe UI Light", 0, 13)); // NOI18N
        retweets.setForeground(new java.awt.Color(51, 51, 51));
        retweets.setLineWrap(true);
        retweets.setRows(100000);
        retweets.setToolTipText("Tous les retweets depuis la création");
        retweets.setFocusable(false);
        jScrollPane2.setViewportView(retweets);

        jLabel18.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(49, 6, 25));
        jLabel18.setText("Tweets");

        jLabel19.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(49, 6, 25));
        jLabel19.setText("Retweets");

        btnAffTweets_.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
        btnAffTweets_.setForeground(new java.awt.Color(0, 153, 255));
        btnAffTweets_.setText("Afficher");
        btnAffTweets_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 255), 1, true));
        btnAffTweets_.setContentAreaFilled(false);
        btnAffTweets_.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnAffTweets_.setFocusPainted(false);
        btnAffTweets_.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnAffTweets_MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnAffTweets_MouseExited(evt);
            }
        });
        btnAffTweets_.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAffTweets_ActionPerformed(evt);
            }
        });

        btnViderTweets_.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
        btnViderTweets_.setForeground(new java.awt.Color(0, 153, 255));
        btnViderTweets_.setText("Vider");
        btnViderTweets_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 255), 1, true));
        ...
        btnAffRT_.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
        btnAffRT_.setForeground(new java.awt.Color(0, 153, 255));
        btnAffRT_.setText("Afficher");
        btnAffRT_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 255), 1, true));
        btnAffRT_.setContentAreaFilled(false);
        btnAffRT_.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnAffRT_.setFocusPainted(false);
        btnAffRT_.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnAffRT_MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnAffRT_MouseExited(evt);
            }
        });
        btnAffRT_.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAffRT_ActionPerformed(evt);
            }
        });

        btnViderRT_.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
        btnViderRT_.setForeground(new java.awt.Color(0, 153, 255));
        btnViderRT_.setText("Vider");
        btnViderRT_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 255), 1, true));
        btnViderRT_.setContentAreaFilled(false);
        btnViderRT_.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnViderRT_.setFocusPainted(false);
        btnViderRT_.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnViderRT_MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnViderRT_MouseExited(evt);
            }
        });
        btnViderRT_.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnViderRT_ActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(btnAffTweets_, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(btnViderTweets_, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(btnAffRT_, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(btnViderRT_, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(19, 19, 19)))))
                .addGap(21, 21, 21))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(27, 27, 27)
                        .addComponent(btnAffTweets_, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(btnViderTweets_, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(34, 34, 34)
                        .addComponent(btnAffRT_, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(btnViderRT_, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    public static List<Status> ExtractionTimeline (String user)
    {
        //connexion à l'API
        ...
        //Extraction dans une Status liste
	...
	int pageno = 1;
        ...
        while (true) 
        {
            try 
            {
                ...
                statuses1.addAll(cnx.getHomeTimeline(page));
    ...
    {
        List <Status> liste = ExtractionTimeline(user);
        tweets.setRows(liste.size()*288);
        
        SimpleDateFormat d = new SimpleDateFormat("EEE dd/MM/yyyy à hh:mm:ss");
        int t=0;
        String tw="";
        for(Status status:liste)
	{
            ...
            {
                t++;
                tw=tw+"\nUtilisateur: @"+status.getUser().getScreenName()+"    Date de création: "+d.format(status.getCreatedAt())+"\n-------<Texte>--------------------------------------------------------------------\n"
                        + ""+status.getText()+ "\n\n Retweets: "+status.getRetweetCount()+"      J'aimes: "+status.getFavoriteCount()+""
                        + "\n-------------------------------------------------------------------------------------\n\n\n\n";
            
            }
        }
        
        if(t==0) tweets.setText("< Pas de tweets dans ce compte >");
        else tweets.setText(tw);
    }
    
    public void GetRetweets(String user)
    {
        List <Status> liste = ExtractionTimeline(user);
        retweets.setRows(liste.size()*288);
        SimpleDateFormat d = new SimpleDateFormat("EEE dd/MM/yyyy à hh:mm:ss");
        int t=0;
        String rt="";
        for(Status status:liste)
	{
        ...
        if(t==0) retweets.setText("< Pas de retweets dans ce compte >");
        else retweets.setText(rt);
    }
    ...
    private void btnMinimiserFenetreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMinimiserFenetreActionPerformed
        ...
        TIMELINE.this.setState(ICONIFIED);
    ...
    private void btnAffTweets_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAffTweets_ActionPerformed
    ...
    private void btnAffRT_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAffRT_ActionPerformed
        Twitter AccessAPI = INSCRIPTION.ConnexionAPI(INSCRIPTION.dev_consumerK,INSCRIPTION.dev_consumerS,INSCRIPTION.dev_accessT,INSCRIPTION.dev_accessS);
        
        try {
            GetRetweets(AccessAPI.getScreenName());
        } catch (TwitterException | IllegalStateException ex) {
            Logger.getLogger(TIMELINE.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_btnAffRT_ActionPerformed

    private void btnViderRT_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViderRT_ActionPerformed
       retweets.setText("");
    }//GEN-LAST:event_btnViderRT_ActionPerformed

    private void btnAffTweets_MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAffTweets_MouseEntered
       Police_Gras (btnAffTweets_);
       btnAffTweets_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 255), 2, true));

    }//GEN-LAST:event_btnAffTweets_MouseEntered

    private void btnAffTweets_MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAffTweets_MouseExited
        Police_Normal (btnAffTweets_);
       btnAffTweets_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 255), 1, true));

    }//GEN-LAST:event_btnAffTweets_MouseExited

    private void btnViderTweets_MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnViderTweets_MouseEntered
      Police_Gras (btnViderTweets_);
       btnViderTweets_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 255), 2, true));
    ...
    private void btnViderTweets_MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnViderTweets_MouseExited
        Police_Normal (btnViderTweets_);
       btnViderTweets_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 255), 1, true));
    }//GEN-LAST:event_btnViderTweets_MouseExited

    private void btnAffRT_MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAffRT_MouseEntered
        Police_Gras (btnAffRT_);
         btnAffRT_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 255), 2, true));
    }//GEN-LAST:event_btnAffRT_MouseEntered

    private void btnAffRT_MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAffRT_MouseExited
        Police_Normal (btnAffRT_);
         btnAffRT_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 255), 1, true));
    }//GEN-LAST:event_btnAffRT_MouseExited

    private void btnViderRT_MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnViderRT_MouseEntered
       Police_Gras (btnViderRT_);
        btnViderRT_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 255), 2, true));
    }//GEN-LAST:event_btnViderRT_MouseEntered

    private void btnViderRT_MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnViderRT_MouseExited
       Police_Normal(btnViderRT_);
        btnViderRT_.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 255), 1, true));
    }//GEN-LAST:event_btnViderRT_MouseExited


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JPanel PanelBas;
    private javax.swing.JPanel PanelHaut;
    private javax.swing.JButton btnAffRT_;
    private javax.swing.JButton btnAffTweets_;
    ...
    private javax.swing.JButton btnViderRT_;
    ...
    private javax.swing.JTextArea retweets;
