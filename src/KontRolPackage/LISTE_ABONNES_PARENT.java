...
public class LISTE_ABONNES_PARENT extends javax.swing.JFrame {

    public LISTE_ABONNES_PARENT() {
        initComponents();
    }
    ...
    public void ExtractionAbonnes_Parent () throws TwitterException
    { 
       //connexion a l api 
         ...
         IDs ids = cnx.getFollowersIDs(cnx.getScreenName(),-1);
 		
        if(ids==null)
            liste.setText("<La liste d'abonnés de "+cnx.getScreenName()+" est vide>");
    ...
    private void btnAfficherListeAbns_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAfficherListeAbns_ActionPerformed
        ...
        try {
            ExtractionAbonnes_Parent();
        } catch (TwitterException ex) {
            Logger.getLogger(LISTE_ABONNES_PARENT.class.getName()).log(Level.SEVERE, null, ex);
        }
