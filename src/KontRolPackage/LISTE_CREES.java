...
public class LISTE_CREES extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        listes.setRows(1000);
        listes.setToolTipText("Les listes crées par la cible.");
    ...
    public void ExtractionListesCrees ( String user) throws TwitterException
    {   
        //connexion a l api 
         ...
         ResponseList<UserList> l= cnx.getUserLists(user);
         
         if(l.size()==0)
         {
             listes.setText("<Pas de listes crées>");
         }
    ...
    private void btnAfficher_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAfficher_ActionPerformed
        try {
            ExtractionListesCrees(LOGIN_CIBLE.userCible);
