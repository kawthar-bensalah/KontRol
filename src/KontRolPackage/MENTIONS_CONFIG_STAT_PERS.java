...
import static KontRolPackage.MENTIONS_STATPARDEF.soustitre;
import javax.swing.event.ChangeEvent;


public class MENTIONS_CONFIG_STAT_PERS extends javax.swing.JFrame {

     public static int NbrJourM=7,NbrMoisM=7,NbrAnneeM=7;
     
    public MENTIONS_CONFIG_STAT_PERS() {
        initComponents();
        sliderJours.setValue(NbrJourM);
        sliderMois.setValue(NbrMoisM);
        sliderAnnees.setValue(NbrAnneeM);
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Période personnalisé");
...
public void stateChangedJours(ChangeEvent e) {
        ...
        NbrJourM = sliderJours.getValue();
        nbrJours.setText("Jour(s) = "+NbrJourM);
    ...
    public void stateChangedMois(ChangeEvent e) {
        ...
        NbrMoisM = sliderMois.getValue();
        nbrMois.setText("Mois = "+NbrMoisM);
    ...
    public void stateChangedAnnees(ChangeEvent e) {
        ...
        NbrAnneeM= sliderAnnees.getValue();
        nbrAnnees.setText("Année(s) = "+NbrAnneeM);
    ...
    private void btnSauvegarder_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSauvegarder_ActionPerformed
            ...
            MENTIONS_STATPARDEF.lblJours.setText("Nombre de mentions ce(s) "+NbrJourM+ " dernier(s) jour(s).");
            MENTIONS_STATPARDEF.lblMois.setText("Nombre de mentions ce(s)  "+NbrMoisM+" dernier(s) mois.");
            MENTIONS_STATPARDEF.lblAnnees.setText("Nombre de mentions ce(s) "+NbrAnneeM+" dernière(s) année(s).");
            
            MENTIONS_STATPARDEF.moisM=NbrMoisM;
            MENTIONS_STATPARDEF.jourM=NbrJourM;
            MENTIONS_STATPARDEF.anneeM=NbrAnneeM;
            
            Mention_mois_mois.nb=NbrMoisM;
            Mentions_Mois.nb=NbrMoisM;
            
            Mentions_annee_annee.nb=NbrAnneeM;
            Mentions_Annees.nb=NbrAnneeM;
           
            Mentions_Jours.nb=NbrJourM;
