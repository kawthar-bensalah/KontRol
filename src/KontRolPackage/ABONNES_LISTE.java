...
public class ABONNES_LISTE extends javax.swing.JFrame {

    public ABONNES_LISTE() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        liste.setColumns(20);
        liste.setRows(1000);
        liste.setToolTipText("Les abonnés");
    ...
    public void ExtractionAbonnes ( String user) throws TwitterException
    {   
        //connexion a l api 
    ...
    private void btnAfficherListeAbns_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAfficherListeAbns_ActionPerformed
        try {
            ExtractionAbonnes(LOGIN_CIBLE.userCible);
        } catch (TwitterException ex) {
